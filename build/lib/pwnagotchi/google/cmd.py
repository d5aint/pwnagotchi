...
def add_parsers(subparsers):
    ...
    parser_google_refresh = google_subparsers.add_parser(
        "refresh", help="Refresh Google authentication token"
    )
    return subparsers
...
def auth():
    ...
    user_input = input(
        "By completing these steps you give pwnagotchi access to your personal Google Drive!\n"
    ...
    if user_input.lower() in ("y", "yes"):
        ...
        try:
            ...
            user_input = input(
                "Please copy this URL into a browser, "
